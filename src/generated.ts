...
useGetCharactersQuery.getKey = (variables?: GetCharactersQueryVariables) =>
  variables === undefined ? ['getCharacters'] : ['getCharacters', variables]
useGetCharactersQuery.fetcher = (variables?: GetCharactersQueryVariables) =>
  fetcher<GetCharactersQuery, GetCharactersQueryVariables>(
    GetCharactersDocument,
    variables
  )
export const GetLocationsDocument = /* #__PURE__ */ `
...
>(
  ...
  useQuery<GetLocationsQuery, TError, TData>(
    ...
    fetcher<GetLocationsQuery, GetLocationsQueryVariables>(
...
useGetLocationsQuery.getKey = (variables?: GetLocationsQueryVariables) =>
  variables === undefined ? ['getLocations'] : ['getLocations', variables]
useGetLocationsQuery.fetcher = (variables?: GetLocationsQueryVariables) =>
  fetcher<GetLocationsQuery, GetLocationsQueryVariables>(
    GetLocationsDocument,
    variables
  )
